<?php
class WowAchievement implements IWowAchievement {
	...
	function __construct($id, $locale) {
		...
		$this->setId($id);
		$this->route = $this->setRoute(unserialize(API_LINKS)[$this->locale] . IWowAchievement::ROUTE . $this->id . '?locale=' . $this->locale . '&apikey=' . API_KEY);
	}
