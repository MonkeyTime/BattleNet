...
define('API_KEY', 'j5qhn9ax8yp5vgrtpmmj5a4nbvpfker9'); //https://dev.battle.net/
...
$wow->setLocale('fr_FR');
//basic usage
print_r($wow->getGuildProfile("Kael'thas", 'For the four')->json());
echo '<br>&nbsp;<br>';
print_r($wow->getGuildProfile("Kael'thas", 'For the four')->jsonp());
